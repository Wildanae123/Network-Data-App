...
START "Backend (Flask)" cmd /c "cd backend && echo Starting Flask Development Server... && venv\Scripts\python.exe dev_server.py && echo. && echo Backend server stopped. && pause"
